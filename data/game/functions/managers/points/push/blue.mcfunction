...
execute at @e[type=minecraft:marker,tag=point,tag=!locked,tag=blue,limit=1] run playsound minecraft:entity.zombie_villager.cure master @a[team=yellow] ~ ~ ~ 10 2
